...
final class ThemeSettings {
    ...
    public static function assets($hook): void {if(strpos($hook,'avanik')===false)return;wp_enqueue_media();wp_enqueue_style('avanik-admin',get_template_directory_uri().'/assets/css/avanik-admin.css',['dashicons'],'0.4.1');wp_enqueue_script('avanik-admin',get_template_directory_uri().'/assets/js/avanik-admin.js',['jquery'],'0.4.1',true);}
    public static function menus(): void {
        ...
        remove_submenu_page('options-general.php','avanik-settings');
    }
    ...
    public static function settings(): void {
        $fields=[
          ...
          ['logo','لوگوی سایت',get_template_directory_uri().'/assets/images/avanik-logo.svg','media'],['hero','تصویر هرو / اسلایدر',get_template_directory_uri().'/assets/images/hero-istanbul.svg','media'],
