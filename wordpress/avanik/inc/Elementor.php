...
final class ElementorIntegration {
    ...
    public static function assets(): void {
        ...
        if (did_action('elementor/loaded')) {
            wp_enqueue_style('avanik-elementor');
            wp_enqueue_script('avanik-elementor');
        }
    }
    ...
    public static function widgets($widgets_manager): void {
        ...
        require_once __DIR__ . '/Elementor/WidgetSearch.php';
        require_once __DIR__ . '/Elementor/WidgetHero.php';
        require_once __DIR__ . '/Elementor/WidgetHeader.php';
        require_once __DIR__ . '/Elementor/WidgetFooter.php';
        $widgets_manager->register(new \Avanik\Elementor\WidgetSearch());
        $widgets_manager->register(new \Avanik\Elementor\WidgetHero());
        $widgets_manager->register(new \Avanik\Elementor\WidgetHeader());
        $widgets_manager->register(new \Avanik\Elementor\WidgetFooter());
    }
}
