...
require_once AVANIK_DIR.'/inc/ElementorBuilderWidgets.php';
...
$builderClass=$avanik_prefix.'ElementorBuilderWidgets';if(class_exists($builderClass))$builderClass::boot();
...
add_action('wp_enqueue_scripts',function(){
    ...
    wp_enqueue_style('avanik-ui-v042',AVANIK_URI.'/assets/css/avanik-ui-v042.css',['avanik-reference-v041'],AVANIK_VERSION);
...
add_action('after_setup_theme',function()use($avanik_prefix){$themeClass=$avanik_prefix.'Theme';$setupClass=$avanik_prefix.'ThemeSetup';if(class_exists($themeClass)&&method_exists($themeClass,'boot'))$themeClass::boot();if(class_exists($setupClass)&&method_exists($setupClass,'register'))$setupClass::register();},20);
