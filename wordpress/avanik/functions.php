...
add_action('wp_enqueue_scripts',function(){wp_enqueue_style('avanik-font','https://fonts.googleapis.com/css2?family=Vazirmatn:wght@400;500;600;700;800&display=swap',[],null);wp_enqueue_style('avanik-style',get_stylesheet_uri(),[],AVANIK_VERSION);wp_enqueue_style('avanik-modern-v048',AVANIK_URI.'/assets/css/avanik-modern-v048.css',['avanik-style'],AVANIK_VERSION);wp_enqueue_style('avanik-v049',AVANIK_URI.'/assets/css/avanik-v049.css',['avanik-modern-v048'],AVANIK_VERSION);wp_enqueue_script('avanik-modern-v048',AVANIK_URI.'/assets/js/avanik-modern-v048.js',[],AVANIK_VERSION,true);wp_enqueue_script('avanik-v049',AVANIK_URI.'/assets/js/avanik-v049.js',['avanik-modern-v048'],AVANIK_VERSION,true);wp_localize_script('avanik-v049','AvanikData',['ajaxUrl'=>admin_url('admin-ajax.php'),'home'=>home_url('/')]);});
...
add_action('after_setup_theme',function()use($avanik_prefix){$themeClass=$avanik_prefix.'Theme';$setupClass=$avanik_prefix.'ThemeSetup';if(class_exists($themeClass))$themeClass::boot();if(class_exists($setupClass))$setupClass::register();},20);
