...
<footer class="av-footer" dir="rtl">
  <div class="av-container av-footer__main">
    <div class="av-footer__grid">
      <div class="av-footer__brand"><img src="<?php echo esc_url($theme_uri.'/assets/images/avanik-logo.svg'); ?>" alt="آوانیک پرواز آسیا"><p>آوانیک پرواز آسیا، ارائه‌دهنده خدمات مسافرتی و گردشگری با تمرکز بر کیفیت، سرعت و تجربه بهتر سفر.</p><div class="av-footer__social"><a href="#" aria-label="اینستاگرام">◎</a><a href="#" aria-label="تلگرام">➤</a><a href="#" aria-label="واتساپ">◔</a><a href="tel:<?php echo esc_attr(preg_replace('/[^0-9+]/','',$phone)); ?>" aria-label="تماس">☎</a></div></div>
      ...
      <div><h3>لینک‌های سریع</h3><p><a href="<?php echo esc_url(home_url('/')); ?>">صفحه اصلی</a></p><p><a href="<?php echo esc_url(home_url('/about')); ?>">درباره ما</a></p><p><a href="<?php echo esc_url(home_url('/contact')); ?>">تماس با ما</a></p><p><a href="<?php echo esc_url(home_url('/dashboard')); ?>">سوالات متداول</a></p><p><a href="<?php echo esc_url(home_url('/contact')); ?>">شرایط و قوانین</a></p></div>
