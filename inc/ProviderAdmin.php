...
final class ProviderAdmin {
  ...
  public static function menu(): void {
    add_menu_page('Avanik Providers', 'Avanik Providers', 'manage_options', 'avanik-providers', [self::class, 'render'], 'dashicons-networking', 26);
  }
  ...
  public static function render(): void {
    ...
    <div class="wrap" dir="rtl">
      <h1>مدیریت Providerهای آوانیک</h1>
      <p>Providerها را فعال/غیرفعال و اولویت آن‌ها را مدیریت کنید.</p>
  ...
  public static function save(): void {
    if (!current_user_can('manage_options') || !check_admin_referer('avanik_save_provider')) wp_die('Unauthorized');
